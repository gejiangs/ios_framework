                           ...
                           failure:(void (^)(NSError *))failure
{
    ...
    return [self.requestOperator getOperationGetWithUrl:url params:nil success:^(BOOL succ, NSString *msg, id responseObject) {
        
        NSDictionary *userdata = [responseObject objectForKey:@"userdata"];
        
        QQModel *model = [QQModel objectWithKeyValues:userdata error:nil];
        success(YES, model);
